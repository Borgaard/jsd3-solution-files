...
var Stock = function(symbol, shares){
  this.symbol = symbol;
  this.shares = shares;
}
...
Stock.prototype.buyShares = function(number) {
  this.shares += number;
  console.log("You now own " + this.shares + " shares of " + this.symbol + ".");
}
...
Stock.prototype.calcValue = function(price){
  console.log("Your " + this.shares + " shares of " + this.symbol + " are currently worth $" + price * this.shares);
}